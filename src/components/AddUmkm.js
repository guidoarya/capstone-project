            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control required name="nama_umkm" type="text" placeholder="Nama UMKM" defaultValue={nama_umkm} onChange={(e) => setNamaUmkm(e.target.value)} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group className="mb-3">
                  <Form.Label>Lokasi</Form.Label>
                  <Form.Control required name="lokasi" type="text" placeholder="Lokasi UMKM" defaultValue={lokasi} onChange={(e) => setLokasi(e.target.value)} />
                </Form.Group>
              </Col>
            </Row>
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control required name="kota" type="text" placeholder="Kota UMKM" defaultValue={kota} onChange={(e) => setKota(e.target.value)} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group className="mb-3">
            ...
            <Row>
              <Col md={6}>
                <Form.Group className="mb-3">
                  ...
                  <Form.Control required name="nomor_hp" type="number" placeholder="No Hp" defaultValue={nomor_hp} onChange={(e) => setNoHp(e.target.value)} />
                </Form.Group>
              </Col>
              <Col md={6}>
                <Form.Group className="mb-3">
                  <Form.Label>Jasa Produk</Form.Label>
                  <Form.Control required type="text" placeholder="Jasa/produk" defaultValue={jasa_produk} onChange={(e) => setJasaProduk(e.target.value)} />
                </Form.Group>
              </Col>
              <Col md={12}>
                <Form.Group className="mb-3">
                  <Form.Label>Deskripsi UMKM</Form.Label>
                  <Form.Control required name="deskripsi" type="text" as="textarea" placeholder="Deskripsi UMKM" defaultValue={deskripsi} onChange={(e) => setDeskripsi(e.target.value)} />
                </Form.Group>
              </Col>
              <Col md={12}>
                <Form.Group className="mb-3">
                  <Form.Label>Gambar</Form.Label>
                  <Form.Control required id="input-gambar" encType="multipart/form-data" name="gambar" type="file" placeholder="Gambar" onChange={(e) => setGambar(e.target.files[0])} />
                </Form.Group>
              </Col>
            </Row>
