      ...
      <Row className="row-container">
        <Col md={6}>
          <Form onSubmit={handleAddUmkm} encType="multipart/form-data">
            <h1 className="mb-4">Ajukan UMKM</h1>
            {/* <Alert variant="danger">{msg}</Alert> */}
            <Form.Group className="mb-3">
              <Form.Label>Nama UMKM</Form.Label>
              <Form.Control name="nama_umkm" type="text" placeholder="Masukkan nama UMKM" value={nama_umkm} onChange={(e) => setNamaUmkm(e.target.value)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Lokasi</Form.Label>
              <Form.Control name="lokasi" type="text" placeholder="Masukkan lokasi UMKM" value={lokasi} onChange={(e) => setLokasi(e.target.value)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Kota</Form.Label>
              <Form.Control name="kota" type="text" placeholder="Masukkan kota UMKM" value={kota} onChange={(e) => setKota(e.target.value)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Deskripsi UMKM</Form.Label>
              <Form.Control name="deskripsi" type="text" as="textarea" placeholder="Masukkan deskripsi UMKM" value={deskripsi} onChange={(e) => setDeskripsi(e.target.value)} />
            </Form.Group>

            <Form.Group className="mb-3">
              <Form.Label>Kategori UMKM</Form.Label>
              <Form.Control name="kategori" type="text" placeholder="Masukkan kategori UMKM" value={kategori} onChange={(e) => setKategori(e.target.value)} />
            </Form.Group>
            ...
            <Form.Group className="mb-3">
              ...
              <Form.Control type="text" placeholder="Masukkan jasa/produk yang dijual" value={jasa_produk} onChange={(e) => setJasaProduk(e.target.value)} />
            </Form.Group>
